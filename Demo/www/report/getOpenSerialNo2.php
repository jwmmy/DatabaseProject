	...
	<div class="col-auto">
		<div class="input-group mb-2">
			<div class="input-group-prepend">
				<div class="input-group-text">表單號碼</div>
			</div>
			<input name="filterValue" type="text" class="form-control" id="filterValue" placeholder="輸入表單號碼" >
		</div>
    </div>
    <div class="col-auto">
		<button type="submit" class="btn btn-primary mb-2" onchange="this.form.submit()">查詢</button>
    </div>
  </div>
</form>
